   ...
   <div class="Layout_score mglayoutscore"> 
      <div class="Header_score mgheaderscore">
         ...
         <div class="Header__SourceInfo-sc-gozq6j-2 mgscoreinfo">
            ...
            {* <div class="HeaderWriteReviewButton__Component-sc-aghmpr-0 etjxIY Header__StyledHeaderWriteReviewButton-sc-gozq6j-4 kjXwdI">
               <button size="15" type="button" tabindex="0" class="ButtonBase__ButtonContainer-sc-p43e7i-3 euBiGU" style="border-radius: 4px; border-color: rgba(0, 0, 0, 0); color: rgb(17, 17, 17); font-family: inherit; font-weight: bold; font-size: 15px; font-style: normal; background-color: rgb(187, 111, 88); border-width: 2px;">
                  <span class="ButtonBase__Overlay-sc-p43e7i-4 jUXzLe" style="padding: 8px 21px; background-color: rgba(0, 0, 0, 0);">
                     <span class="ButtonBase__Ellipsis-sc-p43e7i-5 dqiKFy">Laisser un avis</span>
                  </span>
               </button>
            </div> *}
         </div>
